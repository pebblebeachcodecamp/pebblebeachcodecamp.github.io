...
form.addEventListener('submit', function(event) {
  ...
  // display the results
  if (correct === 4) {
    results.textContent = 'You got 4 out of 4 correct! you pass kinder!';
  } else {
    results.textContent = 'You got ' + correct + ' out of 4 correct. get back to kinder!';
  }
